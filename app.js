...
for (var index = 0; index < library.length; index++) {
    var student_1 = library[index];
    console.log("author Name: ", student_1.author);
    console.log("title name: ", student_1.title);
    console.log("book status: ", student_1.readingStatus);
}
